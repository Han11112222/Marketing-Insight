...
# - 탭0: 연도×용도 스택형 막대
# - 탭1: 월/분기/반기/연간 집계
# - 탭2: [산업용 집중분석] 업종×기간 히트맵 → 셀 선택(클릭 or 드롭다운) 시 고객 Top-N/YoY
...
with tab2:
    ...
    heat.update_layout(template="simple_white", height=560,
                       ...
                       font=dict(family=FONT, size=13), margin=dict(l=80,r=20,t=40,b=40))
    ...
    yo_sel = (yo[yo["Period"] == sel_period].copy()
